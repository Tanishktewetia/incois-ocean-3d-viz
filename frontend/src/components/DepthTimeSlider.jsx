...
function DepthTimeSlider({ depths, selectedDepthIndex, onDepthChange, times, selectedTimeIndex, onTimeChange, isUpdating, onInfoOpen }) {
  ...
  return (
    <section className="control-section" aria-label="Ocean depth and model time controls">
      <div className="control-kicker">Navigate data <InfoButton topic="navigate" onOpen={onInfoOpen} /></div>
